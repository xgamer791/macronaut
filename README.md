...
- **Profile page** — banner and profile picture you upload yourself, name, handle, bio, sport and location, followers / following / posts, a photo wall, fitness groups, and posts; private by default, and one toggle away from a shareable public page at `/u/<handle>` that other accounts can follow. Reached from the avatar in the Today header
